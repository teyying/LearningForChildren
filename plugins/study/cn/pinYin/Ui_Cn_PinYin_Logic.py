...
class UiCn_PinYin_Logic(QWidget, Ui_Cn_PinYin):
    def __init__(self, parent):
        ...
        parent.btnMenu.show()
        self.data = load(open(f'cn/pinYin/pinYin.json', 'r', encoding='utf-8'))
    ...
    def on_textEditDn_textChanged(self):
        try:
            ...
            if lastTextDn == lastTextUp:
                PlaySound('cn/pinYin/sound/Type.wav', flags=1)
                color = 'gray'
            else:
                PlaySound('cn/pinYin/sound/ERROR.wav', flags=1)
                color = 'red'
...
#         act.setIcon(QIcon("cn/pinYin/images/search.png"))
...
#     # # a = load(open('cn/pinYin/pinYin.json', 'r', encoding='utf-8'))
#     # # print(a)
#
#     # b = ''
#     # d = dict()
