...
class UiMath_PlusOrMinus100_Logic(QWidget, Ui_Math_PlusOrMinus100):
    def __init__(self, parent):
        ...
        self.movieNormal = QMovie("math/UiPlusOrMinus100/images/6.gif")
        self.movieWin = QMovie("math/UiPlusOrMinus100/images/7.gif")
        self.labMovie.setMovie(self.movieNormal)
        self.movieNormal.start()

        self.pixRight = QPixmap("math/UiPlusOrMinus100/images/3.png")
        self.pixWrong = QPixmap("math/UiPlusOrMinus100/images/4.png")
        self.pixSmile = QPixmap("math/UiPlusOrMinus100/images/5.png")
